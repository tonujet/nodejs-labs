...
const task3 =
  userController.updateVideoFromSubscriptionsView("Stephanie Bulger");
const task4 = channelController.updateChannelInfoView(
  "79f6ce8f-ee0c-4ef5-9c36-da06b7f4cb76"
);
